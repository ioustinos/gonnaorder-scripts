...
- Per-function-call cap: 100 rows. The UI chunks larger imports automatically and shows progress across batches. (Earlier 300-row chunks tripped Netlify's 10s function timeout on real GonnaOrder latency; 100 gives ~3–5× headroom.)
